...
export function EditDelivererModal({
  name,
  username,
  password,
  googleEmail,
  ...
  onCancel,
  onSubmit
}: EditDelivererModalProps) {
  return (
    <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/40 backdrop-blur-xs p-4 overflow-y-auto animate-fade-in" id="edit-deliverer-dialog">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full overflow-hidden border border-slate-100 p-6 space-y-4 animate-in fade-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center border-b pb-3">
          <h3 className="text-base font-bold font-display text-slate-900">Editar Cadastro do Entregador</h3>
